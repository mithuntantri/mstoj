  ...
  */
  ...
  var nDrawer = {
    ...
    show: function(){
      ...
      drawer.style.msTransform = 'translateX(0)';
      drawer.style.MozTransform = 'translateX(0)';
    ...
    hide: function(){
      ...
      drawer.style.msTransform = 'translateX(-' + nDrawer.maxWidth + 'px)';
      drawer.style.MozTransform = 'translateX(-' + nDrawer.maxWidth + 'px)';
    ...
    showDashboard: function(index){
      console.log("Inside drawer", index)
    }
  };
  return nDrawer; 
}]);